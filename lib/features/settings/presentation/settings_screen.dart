...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  String _formatStoredTime(String value) {
    return MaterialLocalizations.of(context).formatTimeOfDay(
      _parseTimeOfDay(value),
      alwaysUse24HourFormat: MediaQuery.alwaysUse24HourFormatOf(context),
    );
  }

  String _formatStoredTimeRange(String start, String end) {
    return '${_formatStoredTime(start)} - ${_formatStoredTime(end)}';
  }
    ...
    if (granted) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.t('notifications_enabled'))),
        );
      }
    } else {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.t('permission_denied'))),
        );
      }
    }
  }
  ...
  Future<void> _showTimePickerDialog(String currentTime) async {
    final initialTime = _parseTimeOfDay(currentTime);
  ...
  Future<void> _showResetConfirmation() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(context.t('reset_progress_confirm')),
        content: Text(
          context.t('reset_progress_warning'),
        ),
        actions: [
          TextButton(
    ...
    if (confirmed == true) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(context.t('progress_reset'))),
        );
      }
    }
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _SectionHeader(title: context.t('notifications')),
              const SizedBox(height: AppSpacing.md),
              ...
              _SettingsCard(
                children: [
                  _SwitchTile(
                    ...
                    title: context.t('enable_notifications'),
                    subtitle: context.t('notification_desc'),
                  ...
                  _TapTile(
                    ...
                    title: context.t('reminder_time'),
                    subtitle: _formatStoredTime(notifPrefs.reminderTime),
                  ...
                  _TapTile(
                    ...
                    title: context.t('quiet_hours'),
                    subtitle: _formatStoredTimeRange(
              ...
              if (notifPrefs.enableNotifications) ...[
                _SectionHeader(title: context.t('notification_types')),
                const SizedBox(height: AppSpacing.md),
                _SettingsCard(
                  children: [
                    _SwitchTile(
                      icon: Icons.school_rounded,
                      title: context.t('learning_reminders'),
                      subtitle: context.t('daily_lesson_reminders'),
                      value: notifPrefs.learningReminders,
                      onChanged: (value) async {
                        final newPrefs =
                            notifPrefs.copyWith(learningReminders: value);
                        await ref
                            .read(notificationPrefsProvider.notifier)
                    ...
                    _SwitchTile(
                      ...
                      title: context.t('ahimsa_prompts'),
                      subtitle: context.t('mindful_checkins'),
                      value: notifPrefs.ahimsaPrompts,
                      onChanged: (value) async {
                        final newPrefs =
                            notifPrefs.copyWith(ahimsaPrompts: value);
                        await ref
                            .read(notificationPrefsProvider.notifier)
                            .updatePrefs(newPrefs);
                        await NotificationService.scheduleAllNotifications();
                    ...
                    _SwitchTile(
                      ...
                      title: context.t('reflection_prompts'),
                      subtitle: context.t('evening_reflection'),
                      value: notifPrefs.reflectionPrompts,
                      onChanged: (value) async {
                        final newPrefs =
                            notifPrefs.copyWith(reflectionPrompts: value);
                        await ref
                            .read(notificationPrefsProvider.notifier)
                            .updatePrefs(newPrefs);
                        await NotificationService.scheduleAllNotifications();
                    ...
                    _SwitchTile(
                      ...
                      title: context.t('streak_alerts'),
                      subtitle: context.t('streak_at_risk'),
                      value: notifPrefs.streakRiskAlerts,
                      onChanged: (value) async {
                        final newPrefs =
                            notifPrefs.copyWith(streakRiskAlerts: value);
                        await ref
                            .read(notificationPrefsProvider.notifier)
                            .updatePrefs(newPrefs);
                        await NotificationService.scheduleAllNotifications();
              ...
              // Data section
              _SectionHeader(title: context.t('data')),
              const SizedBox(height: AppSpacing.md),
              ...
              _SettingsCard(
                children: [
                  _TapTile(
                    ...
                    title: context.t('reset_progress'),
                    subtitle: context.t('reset_progress_desc'),
              ...
              // About section
              _SectionHeader(title: context.t('about')),
              const SizedBox(height: AppSpacing.md),
